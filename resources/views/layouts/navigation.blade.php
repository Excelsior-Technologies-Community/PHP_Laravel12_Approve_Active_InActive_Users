                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        @elseif(Auth::user()->isCustomer())
                            ...
                            <x-nav-link :href="route('customer.requests.index')" :active="request()->routeIs('customer.requests*')">
                                {{ __('My Requests') }}
                            </x-nav-link>
                            <x-nav-link :href="route('customer.profile.show')" :active="request()->routeIs('customer.profile*')">
                                {{ __('Profile') }}
                            </x-nav-link>
                        @endif
                    @endauth
        ...
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                @elseif(Auth::user()->isCustomer())
                    ...
                    <x-responsive-nav-link :href="route('customer.profile.show')" :active="request()->routeIs('customer.profile*')">
                        {{ __('Profile') }}
                    </x-responsive-nav-link>
                @endif
            @endauth
